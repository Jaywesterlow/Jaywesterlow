...
--fd:"Bricolage Grotesque","Arial Narrow",sans-serif;--fb:"Instrument Sans","Helvetica Neue",Arial,sans-serif;--fm:"JetBrains Mono","SF Mono",Menlo,monospace;}
...
p{margin:0}
.label{font-family:var(--fm);font-size:12px;letter-spacing:0.08em;text-transform:uppercase;color:var(--stone-2);font-weight:600}
...
<div style="padding:40px 44px;display:flex;flex-direction:column;gap:40px">
  ...
  <section style="display:grid;grid-template-columns:1.4fr 1fr;gap:40px">
    <div style="display:flex;flex-direction:column;gap:18px"><span class="label">Type · Bricolage Grotesque / Instrument Sans / JetBrains Mono</span>
